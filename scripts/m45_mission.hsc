...
(script dormant bch_encounter
	...
	(if (or (not (editor_mode)) cinematics)
		(begin 
			...
			(cinematic_run_script_by_name 045la_katsplan_v2)	; immediately start the falcon section
...
(script dormant lnc_boarding_control
	...
	(if debug (print "launch: player has entered sabre"))
			...
			(if debug (print "playing launch cinematic..."))
			...
			(if debug (print "switching to wafercombat"))
